...
*/
program:(class_def)+;
class_def: CLASS TYPEID (INHERITS TYPEID)? LEFTCURLY (insides)* RIGHTCURLY SEMICOLON;
...
LEFTCURLY expr RIGHTCURLY SEMICOLON   #method
...
|expr DOT OBJECTID LEFTPAREN (expr)? RIGHTPAREN #callingmethod
