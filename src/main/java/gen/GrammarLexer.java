...
public class GrammarLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"ELSE", "FI", "TRUE", "FALSE", "IF", "IN", "INHERITS", "LET", "LOOP", 
			"POOL", "THEN", "WHILE", "CASE", "ESAC", "OF", "NEW", "ISVOID", "NOT", 
			"ADD", "SUB", "DIV", "MUL", "LEFTPAREN", "RIGHTPAREN", "LEFTCURLY", "RIGHTCURLY", 
			"EQUAL", "LT", "LE", "ASSIGN", "DARROW", "COLON", "SEMICOLON", "AT", 
			"COMMA", "DOT", "TL", "WHITESPACE", "LINECOMMENT", "NUM", "OBJECTID", 
			"TYPEID", "ERROR"
		};
	}
